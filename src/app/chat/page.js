import { Divider, List,IconButton, ListItem, ListItemButton,Avatar } from "@mui/material";
    ...
    <div className="min-h-screen bg-white dark:bg-[#0c1317] flex p-5">
      <div className="flex shadow w-full bg-gray-100 dark:bg-[#222e35]">
        <List className="flex flex-col w-1/3 border dark:border-[#202C33] !py-0 dark:text-white dark:bg-[#111B21]">
          ...
          <span className="!flex items-center !gap-2"><IconButton><Groups className="dark:text-gray-400"/></IconButton> <IconButton><MoreVert className="dark:text-gray-400"/></IconButton></span>
         
          </ListItem>
          <Divider />
          <ListItem className="!p-2 !flex !items-center !gap-1">
            <input className="p-2 dark:bg-[#0c1317] outline-none px-3 rounded-lg w-full" placeholder='Search or start new chat'/>
            <IconButton><FilterList className="dark:text-gray-400"/></IconButton>
          </ListItem>
          <Divider />
        ...
        <div className="flex w-2/3 border-y justify-center item-center dark:border-[#202C33] border-r">
        <Image
        src="/Chat-amico.svg"
        alt="My Image"
        width={500}
